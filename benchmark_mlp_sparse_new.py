...
'''fc1_2 = Dense(256)(dp1)
fc1_2 = SReLU()(fc1_2)
dp1_1 = Dropout(0.5)(fc1_2)

fc1_3 = Dense(256)(dp1_1)
fc1_3 = SReLU()(fc1_3)
dp1_2 = Dropout(0.5)(fc1_3)'''
...
outputs_gender = Dense(1,activation='sigmoid',name='outputs_gender')(dp2)

# fc1_a = Dense(256)(dp1)
# fc1_a = SReLU()(fc1_a)
# dp1_a = Dropout(0.5)(fc1_a)
outputs_age = Dense(1,activation='linear',name='outputs_age')(dp2)
...
model_name = 'mlpnew_%s.hdf5'%'sparse'
...
submission.to_csv('submit_mlp_512_64_delete.csv', index=True, index_label='device_id')
